...
import sys
import os
from mavenpackage import italianceleb.py
...
class TestInput(unittest.TestCase):
    ...
    def test_italianholidays(self):
        ...
        self.assertEqual(italianceleb("All Saints' Day"), "Yup, {} is an Italian holiday!".format(someholi))

    # invalid inputs
    def test_nonitalian(self):
        # you should input wrong data
        self.assertEqual(italianceleb(“Thanksgiving Day"), None)
