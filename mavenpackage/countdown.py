...
def countdown(date_str):
 ...
 #we compute the difference in days between the date inputted by the user and the current local date
 ...
 if diff>0:
   ...
   #if the difference is equal to 0, we say to the user that the input date is the current date
   print("Time left: {} days! The date you input refers to today".format(diff))

 else:
   #if the difference is smaller than 0, we take the absolute value of the difference in days and we
